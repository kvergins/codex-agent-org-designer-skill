...
const SKILL_NAME = "agent-org-designer";

function usage() {
  console.log(`
Codex Agent Org Designer Skill installer

Usage:
  npx codex-agent-org-designer-skill
  codex-agent-org-designer-skill --skills-dir ~/.codex/skills
...
function main() {
  ...
  console.log("  Use $agent-org-designer to design the agents our company should build next.");
}
